/**
 * @file Sidebar.tsx
 * @description Navegação lateral fixa com contador de documentos por rota.
 */
'use client'
...
export function Sidebar() {
  ...
  return (
    <aside style={{ display:'flex',flexDirection:'column',background:'#0f1729',color:'#fff',flexShrink:0,width:'var(--sidebar-width)' }}>

      {/* Logo */}
      <div style={{ padding:'20px 18px 16px',borderBottom:'1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display:'flex',alignItems:'center',gap:'10px' }}>
          <div style={{ width:'30px',height:'30px',borderRadius:'8px',background:'#1d4ed8',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0 }}>
      ...
      <div style={{ padding:'12px 16px',borderTop:'1px solid rgba(255,255,255,0.06)' }}>
        ...
        <p style={{ fontSize:'0.65rem',color:'#1e293b',marginTop:'4px' }}>v0.2.0 — Sprint 2</p>
      </div>
    </aside>
  )
}
